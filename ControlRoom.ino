...
const char* influxHost = "172.27.235.165";
const int influxPort = 8086;
String org = "MDX";
String bucket = "Prison_Data";
String measurementName = "control_room";
String token = "QYQmc_g-0FoV1nH167_1xd4dvx7vkS8V2p2GMZK5ww7MDZh8ns7LU_Kki5td_XkQLDkIpEFjfqNDyiotCZcWZw==";
...
void testInfluxDBConnection() {
  ...
  if (c.connect(influxHost, influxPort)) {
    ...
    if (response.indexOf("InfluxDB") != -1 || response.indexOf("HTTP/1.1") != -1) {
      Serial.println("✓ InfluxDB is responding!");
    } else {
